...
sudo sed -i 's/ro.build.user=[^*]*/ro.build.user=Nie/' "$GITHUB_WORKSPACE"/images/system/system/build.prop
...
zip_md5=${md5:0:10}
rom_name="miui_VERMEER_${port_os_version}_${zip_md5}_${android_version}.0_Nie.zip"
